...
class Weight2Go(wx.Frame):
    def __init__(self):
        ...
        self.input = wx.Panel(notebook)
        self.tips = scrolled.ScrolledPanel(notebook, style=wx.TAB_TRAVERSAL)
        self.tips.SetupScrolling()

        notebook.AddPage(self.input, "Input")
        notebook.AddPage(self.tips, "Graph + Tips")

        self.build_input(notebook)
        self.build_tips()
    ...
    def build_tips(self):
        ...
        self.canvas = FigureCanvas(self.tips, -1, self.figure)
